...
export type ProviderHealth = {code:string;name:string;category:string;enabled:boolean;status:string;reliability:string;last_success_at:string|null;last_failure_at:string|null;freshness_ttl_hours:number|null};
